...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_query = "UPDATE pengeluaran SET tanggal='$tanggal', bidang='$bidang', tujuan='$tujuan', jumlah='$jumlah' WHERE id=$id";
    ...
    <div class="card-body p-4">
        <form action="" method="POST">
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="tanggal" name="tanggal" required value="<?= htmlspecialchars($pengeluaran['tanggal']) ?>">
            </div>
            
            <div class="mb-3">
                <label for="bidang" class="form-label fw-bold">Bidang (Sumber Anggaran / Kategori) <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="bidang" name="bidang" required value="<?= htmlspecialchars($pengeluaran['bidang']) ?>" placeholder="Contoh: Bidang III, Kesekretariatan, Bendahara, dll">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="tujuan" name="tujuan" rows="3" required placeholder="Jelaskan untuk tujuan apa pengeluaran ini digunakan..."><?= htmlspecialchars($pengeluaran['tujuan']) ?></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control text-end" id="jumlah" name="jumlah" required value="<?= number_format($pengeluaran['jumlah'], 0, ',', '.') ?>" onkeyup="formatRupiah(this)">
                </div>
            </div>
